...
using LINQ2DB_MVC_Core_2.Extensions;
...
namespace LINQ2DB_MVC_Core_2.Areas.Identity.Pages.Account.Manage
{
    ...
    public class ExternalLoginsModel : PageModel
    {
        ...
        public IList<PrettyLoginInfo> CurrentLogins { get; set; }

        public IList<PrettyAuthScheme> OtherLogins { get; set; }
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            CurrentLogins = this.GetPrettyLoginInfoList(await _userManager.GetLoginsAsync(user));
            OtherLogins = this.GetPrettyAuthSchemeList((await _signInManager.GetExternalAuthenticationSchemesAsync())
